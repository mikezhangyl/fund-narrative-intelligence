# News Evidence Report Verification

Status: passed

Commands:

- `python -m pytest tests/test_report_writer.py::test_html_report_renders_structured_sections_without_raw_markdown tests/test_cli_pipeline.py::test_optional_news_evidence_is_disclosed_and_added_to_outputs tests/test_reviewed_mapping_enriched_acceptance_script.py -q`
...
- `python scripts/validate_reviewed_mapping_enriched_acceptance.py --output-dir outputs/reviewed_mapping_enriched_acceptance`
  - Result: passed; reviewed reports include `News Evidence`
