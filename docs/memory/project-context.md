...
- Reviewed-mapping enriched acceptance also validates workspace snapshot `data_layers`: holdings, valuation snapshots, financial metrics, news evidence, and derived signal event layers must be present, non-mock, have rows, and disclose source URLs.
